<div class="container-fluid fh5co_footer_bg pb-3">
    <div class="container animate-box">
        <div class="row">
            <div class="col-12 spdp_right py-5"><img src="<?= base_url('assets/home/') ;?>images/white_logo.png" alt="img" class="footer_logo"/></div>
            ...
            <div class="col-12 col-md-5 col-lg-3 position_footer_relative">
                ...
                <div class="footer_makes_sub_font"> Dec 31, 2016</div>
                <a href="#" class="footer_post pb-4"> Success is not a good teacher failure makes you humble </a>
                <div class="footer_position_absolute"><img src="<?= base_url('assets/home/') ;?>images/footer_sub_tipik.png" alt="img" class="width_footer_sub_img"/></div>
            </div>
            <div class="col-12 col-md-12 col-lg-4 ">
                <div class="footer_main_title py-3"> Last Modified Posts</div>
                <a href="#" class="footer_img_post_6"><img src="<?= base_url('assets/home/') ;?>images/allef-vinicius-108153.jpg" alt="img"/></a>
                <a href="#" class="footer_img_post_6"><img src="<?= base_url('assets/home/') ;?>images/32-450x260.jpg" alt="img"/></a>
                <a href="#" class="footer_img_post_6"><img src="<?= base_url('assets/home/') ;?>images/download (1).jpg" alt="img"/></a>
                <a href="#" class="footer_img_post_6"><img src="<?= base_url('assets/home/') ;?>images/science-578x362.jpg" alt="img"/></a>
                <a href="#" class="footer_img_post_6"><img src="<?= base_url('assets/home/') ;?>images/vil-son-35490.jpg" alt="img"/></a>
                <a href="#" class="footer_img_post_6"><img src="<?= base_url('assets/home/') ;?>images/zack-minor-15104.jpg" alt="img"/></a>
                <a href="#" class="footer_img_post_6"><img src="<?= base_url('assets/home/') ;?>images/download.jpg" alt="img"/></a>
                <a href="#" class="footer_img_post_6"><img src="<?= base_url('assets/home/') ;?>images/download (2).jpg" alt="img"/></a>
                <a href="#" class="footer_img_post_6"><img src="<?= base_url('assets/home/') ;?>images/ryan-moreno-98837.jpg" alt="img"/></a>
            </div>
        </div>
...
<script src="<?= base_url('assets/home/') ;?>js/owl.carousel.min.js"></script>
<script src="<?= base_url('assets/home/') ;?>js/tether.js"></script>
